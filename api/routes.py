...
async def cryptobot_webhook(request: Request):
    """Receive payment confirmation from @CryptoBot."""
    from core.crypto_pay import verify_webhook
    ...
    # CryptoBot sends a single update object with update_type="invoice_paid"
    if data.get("update_type") != "invoice_paid":
        return {"ok": True}

    payload = data.get("payload", {}).get("payload", "")
    # payload format: "premium_{telegram_id}_{timestamp}"
