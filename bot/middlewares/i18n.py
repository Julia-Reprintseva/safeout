...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        "welcome": (
            ...
            "💳 Дальше — 550 ⭐ Stars (карта/Apple Pay) или 💎 7 USDT через @CryptoBot.\n\n"
    ...
    "en": {
        "welcome": (
            ...
            "💳 Then — 550 ⭐ Stars (card/Apple Pay) or 7 USDT via @CryptoBot.\n\n"
    ...
    "tr": {
        "welcome": (
            ...
            "💳 Sonrası — 550 ⭐ Stars (kart/Apple Pay) veya @CryptoBot ile 7 USDT.\n\n"
