...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "ask_hotel": "🏨 Название отеля или адрес, если планируешь там ночевать? Или /skip",
    ...
    "en": {
        ...
        "ask_hotel": "🏨 Hotel name or address if you plan to stay overnight? Or /skip",
    ...
    "tr": {
        ...
        "ask_hotel": "🏨 Geceyi orada geçireceksen otel adı veya adres? Veya /skip",
